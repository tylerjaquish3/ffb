...
class UpdateFunFactsTest extends DuskTestCase
{
    protected $currentSeason = 2023;
    protected $lastSeason = 2022;

    // php artisan dusk --filter=testFunFacts

    // Note: if roster positions change, need to change checkRosterForOptimal() method
