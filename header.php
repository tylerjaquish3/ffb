        ...
        <div class="navbar-wrapper">
            <div class="navbar-header">
                <ul class="nav navbar-nav">
                    ...
                    <li class="nav-item"><a href="index.html" class="navbar-brand nav-link"><img alt="branding logo" src="images/robust-logo-light.png" data-expand="images/robust-logo-light.png" data-collapse="images/robust-logo-small.png" class="brand-logo"></a></li>
