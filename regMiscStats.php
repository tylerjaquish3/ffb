...
<table class="table table-responsive table-striped nowrap" id="datatable-misc5" style="display:none;">
	...
	<tfoot>
		<tr>
			<td colspan=5>Longest winning or losing streak to start a season and how it ended</td>
		</tr>
	</tfoot>
</table>
<!-- Win/loss margin -->
...
<!-- Active Streaks -->
<div id="datatable-misc18" style="display:none;">
<?php
$_activeManagers = [];
...
// --- Active win streak: regular season ---
$_regStreaks = [];
...
// --- Active H2H win streak: regular season, top 3 ---
$_h2hStreaks = [];
...
<p class="mb-1"><strong>Active Win Streak vs. Opponent — Top 3</strong></p>
...
<script type="text/javascript">
    ...
    $('#datatable-misc18a').DataTable({
        searching: false,
        paging: false,
        info: false,
        order: [[1, "desc"]]
    });
    $('#datatable-misc18c').DataTable({
        searching: false,
        paging: false,
        info: false,
        order: [[2, "desc"]]
