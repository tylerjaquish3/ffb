...
#[Signature('weekly:records {year?} {week?} {--fun-fact-id= : Process only this specific fun fact ID} {--test : Run in test mode for debugging}')]
...
class WeeklyRecords extends Command
{
    public function handle()
    {
        ...
        if ($testMode) {
            ...
            $result = UpdateWeeklyRecords::dispatchSync($year, $week, false, $funFactId);
