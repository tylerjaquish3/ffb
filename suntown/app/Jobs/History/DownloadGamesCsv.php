...
class DownloadGamesCsv implements ShouldQueue
{
    ...
    // Select all table content, copy, paste into storage/app/private/games/raw.txt, then run: php artisan importGames
    //
    ...
    public function handle(): void
    {
        ...
        if (!Storage::exists('games/raw.txt')) {
            throw new \Exception(
                "No raw.txt found at storage/app/private/games/raw.txt\n" .
                "Go to https://www.pro-football-reference.com/years/{$year}/games.htm, " .
                "select and copy the entire games table, then paste it into storage/app/private/games/raw.txt"
            );
        }
